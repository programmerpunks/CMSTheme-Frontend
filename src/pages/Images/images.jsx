      ...
      >
              ...
              <div className="loader">
                {loading ? (
                  <div className="loader mt-2">
                    <ClipLoader size={20} color="#50b7f5" />
                  </div>
                ) : uploaded ? (
                  <BsCheck size={40} color="green" />
                ) : (
                  <button
        ...
        <Box className="template-images mt-4">
          ...
          {displayImages.length !== 0 &&
            Object.entries(displayImages).map((image) => (
              <img
                src={URL.createObjectURL(image[1])}
                alt="template"
                className="image m-4"
                style={{ opacity: uploaded ? 1 : 0.1 }}
              />
            ))}
        </Box>
